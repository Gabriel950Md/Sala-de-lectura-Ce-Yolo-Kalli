...
<head>
    ...
    <title>Administración de Libros - Ce Yolo Kalli</title>
        ...
        <div class="main-content">
            <header class="dashboard-header">
                ...
                <div class="header-title">
                    ...
                    <p>Gestión del inventario - Ce Yolo Kalli</p>
                </div>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <select name="estatus" id="estatus" class="form-select" required>
                                    <option value="En la Biblioteca">En la Biblioteca</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="idLibro" id="idLibro" class="form-input" required>
                            </div>
                        </div>
                ...
                <div class="table-card">
                                ...
                                <tbody>
                                    @foreach($libros as $libro)
                                        <tr>
                                            ...
                                            <td>{{ $libro->autor }}</td>
                                            <td>
                                                <span class="status-badge {{ $libro->estatus === 'Prestado' ? 'status-borrowed' : 'status-available' }}">
                                                    {{ $libro->estatus }}
                                                </span>
                                            </td>
                                            <td>{{ $libro->genero }}</td>
                                            ...
                                            <td>
                                                <div class="action-buttons">
                                                    <a href="{{ route('libros.edit', $libro) }}" class="btn-edit">
                    ...
                    @else
                        <div class="empty-state">
                            ...
                            <p>Comienza agregando el primer libro al inventario</p>
                        </div>
                    @endif
                </div>
            </div>
